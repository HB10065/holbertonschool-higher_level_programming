...
based on the contents of 8-rectangle.py
'''
...
class Rectangle():
    ...
    Class Methods:
        square: creates an instance of Rectangle with the width
                and the height being the same using only one
                argument
    Methods:
    ...
    Static Methods:
        bigger_or_equal: recieves two Rectangle Instances as
                         arguments and returns the Instance
                         with the bigger area, if both areas
                         are the same returns the first argument
    '''
